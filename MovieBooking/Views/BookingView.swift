...
//  MovieBooking
//
//  Created by Ubaka Ngene on 13/05/2023.
//
...
struct BookingView: View {
    ...
    @State var gradients = [Color("backgroundColor2").opacity(0), Color("backgroundColor2"),Color("backgroundColor2"),Color("backgroundColor2")]
